...
class TodoListViewController: SwipeTableViewController {
    ...
    //MARK: - Another Lifecycle Time Point - Does the Job Before viewDidLoad
    ...
    //MARK: - Another Lifecyle - Gets Called When View is Just About to be Removed from the Navigation
